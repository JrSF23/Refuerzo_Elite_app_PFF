 ...
 *
 * Les mêmes clés que `lang/es/validation.php`, à l'identique : un test compare
 * les trois catalogues et échoue si l'une manque, car une clé absente retombe
 * sur l'espagnol et laisse un message dans une autre langue au milieu d'un
 * formulaire en français.
 *
 * `attributes` est ce qui transforme « Le champ class_group_id est obligatoire »
 * en « Le champ groupe est obligatoire ». C'est la partie qui compte le plus
 * pour qui lit l'erreur : la règle est générique, le nom du champ est ce qui lui
 * dit où regarder.
 */
...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Cette valeur de :attribute est apparue dans une fuite de données. Veuillez en choisir une autre.',
    ],
    ...
    /*
     * Noms des champs, dans les mots de l'établissement.
     *
     * C'est ce qui transforme « Le champ class_group_id est obligatoire » en
     * « Le champ groupe est obligatoire ». La règle est générique ; le nom du
     * champ est ce qui dit où regarder.
     */
    'attributes' => [
        ...
        'relationship_label' => 'lien de parenté',
        'specialty' => 'spécialité',
        'bio' => 'présentation',
        'school_name' => 'établissement d’origine',
        'school_level' => 'niveau',
        ...
        'guardian_id' => 'tuteur',
        'student_id' => 'élève',
        'class_group_id' => 'groupe',
        'class_session_id' => 'séance',
