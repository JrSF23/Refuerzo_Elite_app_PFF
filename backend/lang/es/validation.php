 ...
 *
 * `APP_LOCALE` ya era `es`, pero este fichero no existía, así que TODA la
 * validación caía al inglés por `APP_FALLBACK_LOCALE`. El usuario veía
 * «The login field is required.» en una interfaz en español.
 *
 * El juego de claves se extrajo del fichero base de Laravel 12 que hay en
 * `vendor/`, no de una copia de internet: así no falta ninguna regla ni sobran
 * claves de versiones anteriores que nunca se usarían.
 *
 * Los nombres de atributo se traducen abajo, en `attributes`: sin eso el mensaje
 * sale como «El campo first_name es obligatorio».
 */
...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'La contraseña indicada ha aparecido en una filtración de datos. Elija otra.',
    ],
    ...
    /*
    |---------------------------------------------------------------------------
    | Mensajes propios por atributo y regla
    |---------------------------------------------------------------------------
    */
    ...
    |---------------------------------------------------------------------------
    |
    | Sin esto el mensaje sale con el nombre técnico del campo: «El campo
    | first_name es obligatorio». Se cubren los campos de las once entidades que
    | expone la API.
    |
    */
    ...
    'attributes' => [
        ...
        'relationship_label' => 'parentesco',
        'specialty' => 'especialidad',
        'bio' => 'presentación',
        'school_name' => 'centro escolar',
        'school_level' => 'curso',
        ...
        'guardian_id' => 'tutor',
        'student_id' => 'alumno',
        'class_group_id' => 'grupo',
        'class_session_id' => 'sesión',
        ...
        'enrolled_at' => 'fecha de matrícula',
        'title' => 'título',
